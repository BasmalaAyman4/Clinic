...
const EditBranch = ({ data }) => {
    ...
    function finalize(e) {
        ...
        axios
            .post(`http://92.205.235.108:8000/clinic/api/branch/${data.id}`, reqData, {
                headers: {
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title className={`${styles.label}`}>Edit branch</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {/* <Form onSubmit={(e) => finalize(e)}> */}
                    <Form onSubmit={(e) => finalize(e)}>
                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                            <Form.Label className={`${styles.label}`}>Branch name</Form.Label>
