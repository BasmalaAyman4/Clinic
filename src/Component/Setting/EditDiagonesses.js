...
const EditDiagonesses = ({ data }) => {
    ...
    function finalize(e) {
        ...
        axios
            .post(`http://92.205.235.108:8000/clinic/api/diagnoses/${data.id}`, reqData, {
                headers: {
            ...
            .then((response) => {
                if (response.data.status == 200) {
                    toast.success('Diagnoses Edited Successfully');
                }
                handleClose()
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose}>
                <Modal.Header closeButton>
                    <Modal.Title className={`${styles.label}`}>Edit Diagnoses</Modal.Title>
                </Modal.Header>
                <Modal.Body>
...
export default EditDiagonesses
