...
const EditPatient = ({ data }) => {
    ...
    function finalize(e) {
        ...
        axios
            .post(`http://92.205.235.108:8000/clinic/api/patients/${data.id}`, reqData, {
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json'
                }
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} size='lg'>
                <Modal.Header closeButton>
                    <Modal.Title className={`${styles.label}`}>Edit Patient</Modal.Title>
                </Modal.Header>
                <Modal.Body>
