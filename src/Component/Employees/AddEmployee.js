...
const AddEmployee = () => {
    ...
    function finalize(e) {
        ...
        axios
            .post('http://92.205.235.108:8000/clinic/api/addEmployee', reqData, {
                headers: {
        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} size='lg'>
                <Modal.Header closeButton>
                    <Modal.Title className={`${styles.label}`}>Add Employee</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                                ...
                                <Row>
                                    <Col>
                                        <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
                                            ...
                                            <Form.Control type="date" placeholder='' className={`${styles.input}`} name="birth"
